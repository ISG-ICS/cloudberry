...
class ParameterInterpeter {
	...
	static final String DC = "dontclick";
	...
	private Options getOptions() {
		...
		options.addOption(DC, true, "a comma separated list of HTML tags that shouldn't be clicked");
...
*/
    ...
    public boolean specifiesDontClickElements() {
        return parameters.hasOption(DC);
    }

    public String[] getSpecifiedDontclickElements() {
        return parameters.getOptionValue(DC).split(",");
    }
}
