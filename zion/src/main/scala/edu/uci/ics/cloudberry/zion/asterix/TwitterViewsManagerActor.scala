...
object TwitterViewsManagerActor {
  ...
  def generateSubSetViewAQL(sourceName: String, keyword: String): String = {
    ...
    s"""
       ...
       """.stripMargin +
    generateKeywordUpdateAQL(sourceName, viewName, keyword, new DateTime(0), DateTime.now)
  }
  ...
  def generateSummaryViewAQL(sourceName: String, summaryLevel: SummaryLevel): String = {
    ...
    s"""
       ...
       |
     """.stripMargin +
    generateSummaryUpdateAQL(sourceName, viewName, summaryLevel, new DateTime(0), DateTime.now)
