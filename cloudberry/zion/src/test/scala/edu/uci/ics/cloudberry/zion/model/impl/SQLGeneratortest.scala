...
//           |from twitter_ds_tweet t
//           |where t.hashtag is not null and t.create_at >= '2016-01-01T00:00:00.000Z' and t.create_at < '2016-12-01T00:00:00.000Z' and lower(t.text) like '%zika%' and lower(t.text) like '%virus%' and t.geo_tag->"$.stateID" in ( 37,51,24,11,10,34,42,9,44 )
//           |group by hashtag
//           |order by count desc
...
//           |(select hashtag as hashtag,count(*) as count
//           |from twitter_ds_tweet t
//           |where t.hashtag is not null and lower(t.text) like '%zika%' and lower(t.text) like '%virus%' and t.create_at >= '2016-01-01T00:00:00.000Z' and t.create_at < '2016-12-01T00:00:00.000Z' and t.geo_tag->"$.stateID" in ( 37,51,24,11,10,34,42,9,44 )
//           |group by hashtag
//           |order by count desc
//           |limit 10)""".stripMargin.trim)
//    }
