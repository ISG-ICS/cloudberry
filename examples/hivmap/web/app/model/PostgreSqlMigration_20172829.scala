...
private[model] class PostgreSqlMigration_20172829() {

  import PostgreSqlMigration_20172829._
...
object PostgreSqlMigration_20172829 {

  val migration = new PostgreSqlMigration_20172829()
