...
public class ADM {
    ...
    public static final SimpleDateFormat ADMDateFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.US);
    public static final SimpleDateFormat ADMTimeFormat = new SimpleDateFormat("HH:mm:ss.SSS", Locale.US);
    //
