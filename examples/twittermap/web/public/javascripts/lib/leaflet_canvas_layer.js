if(typeof(L) !== 'undefined') {
    ...
    L.CanvasLayer = L.Class.extend({
        ...
        onAdd: function (map) {
            ...
            // the container is moved in the opposite direction of the
            ...
            // hack: listen to pre-drag event launched by dragging to
        ...
        _animateZoom: function (e) {
            ...
            back.style[transform] =  L.DomUtil.getTranslateString(origin) + ' scale(' + e.scale + ') ';
        },
