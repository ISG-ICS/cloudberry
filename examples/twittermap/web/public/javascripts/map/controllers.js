angular.module('cloudberry.map', ['leaflet-directive', 'cloudberry.common','cloudberry.cache'])
  ...
  .directive("map", function () {
    return {
      ...
      controller: 'MapCtrl',
      template:[
        '<leaflet lf-center="center" tiles="tiles" events="events" controls="controls" width="100%" height="100%" ng-init="init()"></leaflet><div ng-controller="multiLayerManager"></div><div ng-controller="pinMapCtrl"></div><div ng-controller="heatMapCtrl"></div>'
      ].join('')
    };
  });
